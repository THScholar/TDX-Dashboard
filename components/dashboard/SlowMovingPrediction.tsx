...
import { AlertTriangle, BarChart4, RefreshCw, Box, Sparkles } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      {analyticsMode !== 'basic' ? (
        ...
        <div className="flex flex-col items-center justify-center h-full text-slate-400 py-10">
          ...
          <p className="text-lg font-semibold">Mode Analitik Basic tidak menyertakan Prediksi Slow-Moving Items.</p>
