...
import { CheckCircle2, ListTodo, RefreshCw, Sparkles } from 'lucide-react';
    ...
    <div className="bg-slate-800 rounded-xl border border-slate-700 shadow-lg overflow-hidden h-[400px] flex flex-col">
      {analyticsMode !== 'basic' ? (
            ...
            {tasks.length === 0 ? (
              ...
              tasks.map(task => (
                ...
                >
                  ...
                  <span className={`text-sm ${task.isCompleted ? 'line-through text-white' : 'text-slate-200'}`}>
                    {task.text}
                  </span>
                </div>
              ))
        ...
        <div className="flex flex-col items-center justify-center h-full text-slate-400 py-10">
          ...
          <p className="text-lg font-semibold">Mode Analitik Basic tidak menyertakan Rekomendasi Tugas Harian.</p>
